...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<Language, Map<String, String>> _translations = {
    Language.es: {
      ...
      'tutorial_step_move_1': 'Toca tu ficha para moverla a la casilla de salida.',
    ...
    Language.en: {
      ...
      'tutorial_step_move_1': 'Tap your token to move it to the starting square.',
      ...
      'tutorial_step_extra_explanation': 'Amazing! By capturing, the opponent earned an additional roll. Tap here to roll again.',
